  ...
  return (
    <div className="sidebar">
      ...
      <div className="create-playlist">
        ...
        <div className="nav-item">
          <div className="icon-wrapper liked">
      ...
      <div className="playlist-section">
        <div className="playlist-list">
          ...
          <div className="playlist-item">Release Radar</div>
          <div className="playlist-item">Your Top Songs 2023</div>
          <div className="playlist-item">Chill Hits</div>
        </div>
      </div>
    </div>
  );
